    ...
    async function fetchHistory() {
        try {
            ...
            if (res.ok) {
                ...
                historyList.innerHTML = '<tr><td colspan="3" class="loading-state">Failed to load</td></tr>';
            }
        } catch (err) {
            console.error('API Error:', err);
            historyList.innerHTML = '<tr><td colspan="3" class="loading-state">Network error</td></tr>';
        }
    }
